	...
	d3.json("allCsdata.json", function(error, data) {
...
*/
	    ...
	    var user_data = [];
		 ...
		 if (isNaN(d.depth)){			 
			 console.log (d.depth , ' is a NaN');
		 }	
		 else if (isNaN(d.cs134)){			 
			 console.log (d.cs134 , ' is a NaN');
		 }	
...
/*
	     user_data.push({
	            "lon": Number(d.coordinates[0]),
	            "lat": Number(d.coordinates[1]),
	            "value": Number(d.cs137),
